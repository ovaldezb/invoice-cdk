...
def update_receptor(id_receptor: str, receptor_data: dict, receptor_collection):
    """Update receptor by id_receptor (which is the RFC)"""
    return receptor_collection.update_one({"_id": id_receptor}, {"$set": receptor_data})
